...
export function EditProductDialog({ 
  ...
  const [selectedImageId, setSelectedImageId] = useState<string>(product.image?.id || "none")
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select name="country" defaultValue={product.country || "none"}>
                <SelectTrigger id="country">
                  <SelectValue placeholder="Selecteer land" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">Geen land</SelectItem>
            ...
            <div>
              ...
              <Select name="floraType" defaultValue={product.floraType || "none"}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select name="packagingType" defaultValue={product.packagingType || "none"}>
                <SelectTrigger id="packagingType">
                  <SelectValue placeholder="Selecteer verpakking" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">Geen verpakking</SelectItem>
            ...
            <div>
              ...
              <Select name="milkType" defaultValue={product.milkType || "none"}>
                <SelectTrigger id="milkType">
                  <SelectValue placeholder="Selecteer melksoort" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">Geen melksoort</SelectItem>
                  {MILK_TYPES.map((type) => (
                    <SelectItem key={type.value} value={type.value}>
                      {type.label}
                    </SelectItem>
